                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Somanth Nagar, Pune 14</span> <br>
										<span class="text-white"> wadgaon sheri , Pune 14</span>
										</div>
                                </li>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-white">rameshwar@realestatest.com</span>
										<span class="text-white">ajay@realestatest.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
