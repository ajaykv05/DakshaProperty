...
<!-- FOR MORE PROJECTS visit: codeastro.com -->
		...
		<!-- FOR MORE PROJECTS visit: codeastro.com -->
        <!--	Contact Information -->
        <div class="full-row" style="margin-left:150px">
            <div class="container" style="margin-left:150px">
                <div class="row" >
                    ...
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<h2 class="orcolor double-down-line text-center mb-5">Get In Touch</h2>
								<?php echo $msg; ?><?php echo $error; ?>
							</div>
						</div><!-- FOR MORE PROJECTS visit: codeastro.com -->
						<div class="row">
							<div class="col-md-12">
								<form class="w-100" action="https://api.web3forms.com/submit" method="POST">
									<div class="row">
									<input type="hidden" name="access_key" value="2ec01939-d5d0-4b6e-ac82-8863256c5078">
										<div class="row mb-4">
