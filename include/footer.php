<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="nav-logo" src="images/logo/DakshLogo.png" alt="" style="width:100px; height:100px;"></a> </div>
                                        <p class="pb-20 text-white">At Daksha Property, we specialize in connecting people with their dream homes and investment opportunities. We offer a wide range of real estate services, including residential, commercial, and land properties.</p>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Real Estate Website - Developed By Rameshwar & Ajay </span> </div>
                    <div class="col-sm-6">
